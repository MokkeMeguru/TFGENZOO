...
** News [2020/4/24]
 ...
 - pipenv
   #+begin_src
   pipenv install git+https://github.com/MokkeMeguru/TFGENZOO.git@v1.0-beta0#egg=TFGENZOO
   #+end_src
  
 - pip
   #+begin_src
   pip install git+https://github.com/MokkeMeguru/TFGENZOO.git@v1.0-beta0#egg=TFGENZOO
   #+end_src
